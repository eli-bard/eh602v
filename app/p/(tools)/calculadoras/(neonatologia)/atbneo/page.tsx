...
export default function CalculadoraAntibioticosNeonatais() {
  ...
  const { daysOfLife, correctedAgeWeeks, correctedAgeDays } = useMemo(() => {
    if (!birthDate)
      return { daysOfLife: 0, correctedAgeWeeks: 0, correctedAgeDays: 0 };
    ...
    const gestAge = parseFloat(gestationalAge);
    if (!isNaN(gestAge) && gestAge < 37) {
      const correctedWeeks = gestAge + daysOfLife / 7;
      const correctedWeeksInt = Math.floor(correctedWeeks);
      const correctedDaysInt = Math.round(
        (correctedWeeks - correctedWeeksInt) * 7
      );
      return {
        daysOfLife,
        correctedAgeWeeks: correctedWeeksInt,
        correctedAgeDays: correctedDaysInt,
      };
    }

    return { daysOfLife, correctedAgeWeeks: 0, correctedAgeDays: 0 };
  }, [birthDate, currentDate, gestationalAge]);

  // Função para calcular idade corrigida em semanas completas
  const getCorrectedAgeWeeks = () => {
    const gestAge = parseFloat(gestationalAge);
    if (isNaN(gestAge) || gestAge >= 37) return null;

    return Math.floor(gestAge + daysOfLife / 7);
  };
  ...
  const calculations = useMemo<CalculationResult | null>(() => {
    ...
    const correctedWeeks = getCorrectedAgeWeeks();
    const isPreterm = gestAge < 37;
    const correctedAge = isPreterm ? correctedWeeks || gestAge : gestAge;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-700 text-lg">
            Calcule doses e prescrições de antibióticos para neonatologia
            baseado no peso, idade gestacional e dias de vida
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                step="1"
              />
              <p className="text-sm text-gray-500">Semanas de gestação</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full p-4 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition"
              />
              <p className="text-sm text-gray-500">Data da prescrição</p>
            </div>
          </div>
          ...
          {(birthDate || gestationalAge) && (
            <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                {gestationalAge && parseFloat(gestationalAge) < 37 && (
                  <>
                    <div className="text-center p-3 bg-white rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-blue-700">
                        {correctedAgeWeeks}s {correctedAgeDays}d
                      </p>
                    </div>
                    <div className="text-center p-3 bg-white rounded-lg">
                      <p className="text-sm text-gray-600">Semanas Completas</p>
                      <p className="text-2xl font-bold text-blue-700">
                        {getCorrectedAgeWeeks()} semanas
                      </p>
                    </div>
                  </>
                )}
        ...
        {calculations ? (
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                  <div className="text-center p-4 bg-blue-50 rounded-xl">
                    ...
                    <p className="text-2xl font-bold text-blue-700">
                      {calculations.penicilina.doseUI.toLocaleString("pt-BR")}{" "}
                      UI/kg/dose
                    </p>
                  </div>
                  <div className="text-center p-4 bg-blue-50 rounded-xl">
              ...
              <div className="p-6">
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-2 text-sm text-yellow-700 bg-yellow-50 p-3 rounded-lg">
                    ⚠️ <strong>Nefrotóxico:</strong> Considerar trocar por
                    Cefepime para melhorar a transição. Monitorar função renal.
                  </div>
                  <button
                    onClick={() =>
          ...
          <div className="text-center py-16 bg-white rounded-2xl shadow-xl">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              Por favor, insira o peso, data de nascimento e idade gestacional
              para calcular as doses dos antibióticos.
            </p>
          </div>
        )}
        ...
        <div className="mt-12 pt-6 border-t border-gray-300">
          <p className="text-sm text-gray-600 text-center">
            *Esta calculadora é uma ferramenta de apoio clínico. As informações
            fornecidas são baseadas em diretrizes pediátricas e devem ser
            validadas por profissional médico qualificado. Sempre consulte as
            referências atualizadas e utilize o julgamento clínico para decisões
            terapêuticas.*
          </p>
          <p className="text-xs text-gray-500 text-center mt-4">
            Fonte: Protocolos de antibióticos em neonatologia - Baseado em
