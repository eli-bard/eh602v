...
export default function IdadeNeonatal() {
  ...
  const calcularIdadeCorrigida = useCallback(
    (dataNasc: string) => {
      ...
      if (semanasGestacao > 0 && semanasGestacao < 37) {
        ...
        // acrescentei o -1 nos diasCorrigidosTotal pois estava com erro no cálculo de idade gestacional corrigida, dando 1 dia a mais.
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white dark:bg-gray-900 rounded-lg shadow-md dark:shadow-gray-700">
      ...
      <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-2">
          <div className="bg-white dark:bg-gray-700 p-3 rounded-md shadow-sm dark:shadow-gray-900">
            ...
            <p className="text-lg font-semibold dark:text-gray-100">{idade}</p>
          </div>
